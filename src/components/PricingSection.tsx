    ...
    <section id="harga" className="py-20 lg:py-28 px-4 sm:px-6 lg:px-8 bg-[#f9fbe5] text-[#0d0d0d]">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-3">
          {PACKAGES.map((pkg) => (
            <div key={pkg.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-4 px-5 py-4 rounded-2xl border border-[#0d0d0d] cursor-default">
